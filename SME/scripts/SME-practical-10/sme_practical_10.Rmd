...
source(here("SME/scripts/SME-practical-10/mh_functions_updated.R"))
...
Let's check if age is a confounder (checking the assumptions of our causal graph). Is our exposure (onchocerchal infection) somehow associated with age?
...
mod3<-glm(died ~ vimp + mfpos + agegrp,
    data = mortality,
    family = binomial()) 
summary(mod3)
```
