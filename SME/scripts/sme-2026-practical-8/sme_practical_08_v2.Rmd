...
here::here()
source(here("SME", "scripts","sme-2026-practical-8","blik_function.R")) 
source(here("SME", "scripts","sme-2026-practical-8","bloglik_function.R"))
source(here("SME", "scripts","sme-2026-practical-8","plik_function.R"))
source(here("SME", "scripts","sme-2026-practical-8","ploglik_function.R"))
...
ggsave(here('SME','scripts','sme-2026-practical-8','q1_combined.png'),combined_plot,width=8,height=12)
...
print(combined_plot)
#analogous to 90% confidence intervals, reduces the range of supported values pi
```
...
combined_plot13 <- q13a / q13b
print(combined_plot13)
```
